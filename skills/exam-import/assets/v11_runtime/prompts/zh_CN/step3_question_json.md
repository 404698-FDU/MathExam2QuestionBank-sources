  ...
  "tools": [
    {
      "type": "function",
      "function": {
        "name": "image_only_question_standardization",
        "description": "根据题面裁剪图和答案解析裁剪图整理指定题号的题干、选项、答案、解析和问题标记。",
        "parameters": {}
      }
    }
  ],
...

{
  ...
  "properties": {
    "schema_version": {
      "type": "string",
      "enum": ["image_only_question_standardization_v1"]
    },
    "question_no": {
      "type": "integer",
      "description": "必须等于输入指定题号。"
    },
    "stem_markdown": {
      "type": "array",
    ...
    "options_markdown": {
      "type": "array",
      "description": "按 stem_markdown 中 <options no=\"...\"> 的顺序输出选项组。",
      "items": {
        "type": "object",
        "additionalProperties": false,
        "required": ["no", "options"],
        "properties": {
          ...
          "options": {
            ...
            "items": {
              "type": "object",
              "additionalProperties": false,
              "required": ["label", "content_markdown"],
              "properties": {
                "label": {
                  "type": "string",
