...
source_runs/<run_id>/{paper,answer}/pages/page_*.png
```
...
```text
question_groups[].block_labels
question_groups[].question_surface_labels
qa_alignment[].answer_items[].block_labels
```
