...
来源代码：`step3_5_full_latex_normalize.py`
...
```text
reviews_step3_5_full_latex_normalize/<run_id>/normalized_question_bank.json
reviews_step3_5_full_latex_normalize/<run_id>/merged_question_bank.json
reviews_step3_5_full_latex_normalize/<run_id>/summary.json
```
...
```text
runs_question_bank/<run_id>/question_bank.json
runs_question_bank/<run_id>/question_bank.before_step3_5_full_latex_normalize.json
```
